...
var stdRender = {
	...
	createMedia : function(obj){
		...
		//if(obj.ctx_num == 1){
			...
			var html = "";
			if(obj.type == "image" || obj.type == "logo" || obj.type == "android_image")
			{	
	...
	setMedia : function(obj){
		...
		if(type=="image" || type=="logo" || type == "android_image")
		{
	...
	copyElmIfOnlyOne: function()
	{
		$('body').find('.gallery').each(function(){
			if(isRunningOnAndroid != true && ($(this).attr('type') == 'video' || $(this).attr('type') == 'android_video'))
			{
