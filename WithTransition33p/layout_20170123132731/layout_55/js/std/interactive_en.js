...
$.fn.interactive = function(options) {
      ...
      function registerAction(){ // to get token
        ...
        $.ajax({
            ...
            error: function(){
              if(widget_type == 'key_app'){
                game_handle[settings.id].setActivityCodeTitle("Not in service...");
                game_handle[settings.id].setActivityCodeNumber("");
                $('#activity_code_span').html('Not in service...');
              }else if(widget_type == 'vote_app'){
                d3.select('#activitycodetitle_'+settings.id).text("Not in service...");
            ...
            success: function(obj) {
              ...
              if(status == 0){
                  ...
                  if(widget_type == 'key_app'){
                    ...
                    d3.select('#activitycodetitle_'+settings.id).text("Timeout!");
                  }
